...
Not Flexprice, but adjacent org discoveries:
...
| [digimata/kdb](https://github.com/digimata/kdb) | Knowledge + code structural CLI/LSP | Internal engineering; see team notes |
| [digimata/quill](https://github.com/digimata/quill) | Local macOS meeting record + STT | Adjacent to voice capture; not a Samantha dependency |
